...
volatile uint16_t adc_feedback_buffer[2];
volatile uint16_t adc_feedback_values[2];
...
void HAL_ADC_MspInit(ADC_HandleTypeDef *adcHandle) {
  ...
  */
    ...
    PA3     ------> ADC1_IN3
    */
        GPIO_InitStruct.Pin = FEEDBACK_1_Pin | FEEDBACK_2_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef *adcHandle) {
    ...
    PA3     ------> ADC1_IN3
    */
        HAL_GPIO_DeInit(GPIOA, FEEDBACK_1_Pin | FEEDBACK_2_Pin);
...
void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef *hadc) {
    ...
    memcpy((void *)adc_feedback_values, (void *)adc_feedback_buffer, sizeof(adc_feedback_buffer));
}

volatile uint16_t *adc_get_feedback_values(void) {
    return adc_feedback_values;
}
