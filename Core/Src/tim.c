...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef *timHandle) {
    ...
    PB6     ------> TIM1_CH3
    */
        GPIO_InitStruct.Pin = AMS_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
        GPIO_InitStruct.Alternate = GPIO_AF2_TIM1;
        HAL_GPIO_Init(AMS_GPIO_Port, &GPIO_InitStruct);
        ...
        GPIO_InitStruct.Pin = ADRESS_LED_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
        GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
        HAL_GPIO_Init(ADRESS_LED_GPIO_Port, &GPIO_InitStruct);
    ...
    PA7     ------> TIM3_CH2
    */
        GPIO_InitStruct.Pin = TS_OFF_Pin | TSAL_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void tim_set_pwm(enum IndicatorsName indicator, float luminosity) {
    ...
    uint16_t pwm_value_16 = (uint16_t)(luminosity * MAX_PWM_VALUE);
...
bool tim_test_timers_initialized() {
