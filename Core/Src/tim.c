...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef *timHandle) {
    ...
    PA5     ------> TIM1_CH1
    */
        GPIO_InitStruct.Pin = AMS_Pin | IMD_Pin;
    ...
    PA0     ------> TIM2_CH1
    */
        GPIO_InitStruct.Pin = ADDRESS_LED_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
        GPIO_InitStruct.Alternate = GPIO_AF3_TIM2;
        HAL_GPIO_Init(ADDRESS_LED_GPIO_Port, &GPIO_InitStruct);
    ...
    PA7     ------> TIM3_CH2
    */
        GPIO_InitStruct.Pin = TSAL_RED_Pin | TS_OFF_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
